...
public class Messages {
  ...
  public static final class PrinterCapabilities {
    ...
    private @Nullable Boolean supportsColor;

    public @Nullable Boolean getSupportsColor() {
      return supportsColor;
    }

    public void setSupportsColor(@Nullable Boolean setterArg) {
      this.supportsColor = setterArg;
    }
    ...
    public boolean equals(Object o) {
      ...
      return pigeonDeepEquals(supportsColor, that.supportsColor) && pigeonDeepEquals(supportsDuplex, that.supportsDuplex) && pigeonDeepEquals(maxCopies, that.maxCopies) && pigeonDeepEquals(supportedPageSizes, that.supportedPageSizes);
    }

    @Override
    public int hashCode() {
      Object[] fields = new Object[] {getClass(), supportsColor, supportsDuplex, maxCopies, supportedPageSizes};
      return pigeonDeepHashCode(fields);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setSupportsColor(@Nullable Boolean setterArg) {
        this.supportsColor = setterArg;
        return this;
      }
      ...
      public @NonNull PrinterCapabilities build() {
        ...
        pigeonReturn.setSupportsColor(supportsColor);
    ...
    ArrayList<Object> toList() {
      ArrayList<Object> toListResult = new ArrayList<>(4);
      toListResult.add(supportsColor);
    ...
    static @NonNull PrinterCapabilities fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      Object supportsColor = pigeonVar_list.get(0);
      pigeonResult.setSupportsColor((Boolean) supportsColor);
  ...
  public static final class PrinterInfo {
    ...
    public boolean equals(Object o) {
      ...
      return pigeonDeepEquals(label, that.label) && pigeonDeepEquals(address, that.address) && pigeonDeepEquals(description, that.description) && pigeonDeepEquals(isDefault, that.isDefault) && pigeonDeepEquals(capabilities, that.capabilities) && pigeonDeepEquals(isAvailable, that.isAvailable);
    }

    @Override
    public int hashCode() {
      Object[] fields = new Object[] {getClass(), label, address, description, isDefault, capabilities, isAvailable};
      return pigeonDeepHashCode(fields);
    }
  ...
  public interface FlutterPrintApi {
     ...
     */
    void print(@NonNull String filePath, @NonNull PrintOptions options);
    /**
     ...
     */
    void printPreview(@NonNull String filePath, @NonNull PrintOptions options);
    /**
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable FlutterPrintApi api) {
      messageChannelSuffix = messageChannelSuffix.isEmpty() ? "" : "." + messageChannelSuffix;
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.flutter_print.FlutterPrintApi.print" + messageChannelSuffix, getCodec());
        if (api != null) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.flutter_print.FlutterPrintApi.printPreview" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.flutter_print.FlutterPrintApi.listPrinters" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.flutter_print.FlutterPrintApi.pickPrinter" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
